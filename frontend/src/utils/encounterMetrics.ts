...
/**
 * EncounterMetrics: métricas derivadas de los participantes de un encuentro.
 */
export type EncounterMetrics = {
  totalXp: number;
  adjustedXp: number;
  multiplier: number;
  monsterCount: number;
...
export function computeEncounterMetrics(participants: EncounterSummary['participants']): EncounterMetrics {
